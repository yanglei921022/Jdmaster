...
public class XiaKuanLvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater mLayoutInflater;
    private Context mContext;
    private List<Json> mTitle;
    private String  mAid;

    public XiaKuanLvAdapter(Context context, List<Json> title, String aid) {
        mContext = context;
        mTitle = title;
        mAid=aid;

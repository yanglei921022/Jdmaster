...
public class ShowCity {
    ...
    public ShowCity(Activity getActivity, TextView textView, List<String> list) {
  ...
  //  private String constellations[] = {"公交车站", "公交车身", "社区广告", "地铁灯箱"};
    ...
    private void setButtonListeners(RelativeLayout layout) {
        ...
        GirdDropDownAdapter girdDropDownAdapter = new GirdDropDownAdapter(getActivity, list);
